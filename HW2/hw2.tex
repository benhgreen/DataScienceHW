...
\noindent Set {10 9 1 7 10} would have to be in the set since the estimate of the number of distinct elements is 2\textasciicircum r where r is the max tail length in the set.
